...
So, it means we have somewhere to host my static website, for free!

### ~~1. Buying Domain & Hosting~~(Solved)

We have solved our first challenge. In the next part I will solve the 2nd part so that you can make an actual blog where you will need less knowledge about the technical stuffs. You'll be able to create a blog by creating `markdown` files. Comment if you have any queries.  
See you soon...
